  ...
  return (
    <div className="auth">
      <form onSubmit={submit} className="card form">
        ...
        <button>{type === 'login' ? 'Login' : 'Create Account'}</button>
      ...
      <div className="list">
        {projects.map((p) => (
          <div className="card" key={p._id}>
            ...
            <p>{p.description}</p>
            <p>
              <b>Members:</b> {p.members.map((m) => m.name).join(', ')}
            </p>
      ...
      <div className="list">
        {tasks.map((t) => (
          <div className="card task" key={t._id}>
            ...
            <p>{t.description}</p>
            <p>
              <b>Project:</b> {t.project?.name} | <b>Assigned:</b>{' '}
              {t.assignedTo?.name}
            </p>
            <p>
              <b>Priority:</b> {t.priority} | <b>Due:</b>{' '}
              {new Date(t.dueDate).toLocaleDateString()}
            </p>

            <select
              value={t.status}
              onChange={(e) => status(t._id, e.target.value)}
            >
              <option>Todo</option>
            ...
            {user.role === 'Admin' && (
              <button className="danger" onClick={() => del(t._id)}>
                Delete
              </button>
            )}
          </div>
